...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level
      ...
      - 'All': Show only activities with no difficulty specified (for all skill levels)
      - omitted/empty: Show all activities regardless of difficulty
    """
    ...
    if difficulty:
        if difficulty == "All":
            # "All" means activities with no difficulty specified (for all skill levels)
